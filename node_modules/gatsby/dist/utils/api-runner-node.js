...
const _require2 = require(`./stack-trace-utils`),
      getNonGatsbyCodeFrame = _require2.getNonGatsbyCodeFrame; // Bind action creators per plugin so we can auto-add
...
const runAPI = (plugin, api, args) => {
  ...
  if (gatsbyNode[api]) {
    ...
    const _require5 = require(`../redux/actions`),
          boundActionCreators = _require5.boundActionCreators;
